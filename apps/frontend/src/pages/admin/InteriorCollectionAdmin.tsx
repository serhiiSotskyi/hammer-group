...
export default function InteriorCollectionAdmin() {
  ...
  if (cats.isLoading || cols.isLoading) return <p className="p-6">Loading…</p>;
  if (!interior || !current) return <p className="p-6 text-red-500">Collection not found</p>;

  return (
    <div>
      <br /><br /><br /><br />
      <h1 className="text-3xl font-bold mb-6">{current.name} · Interior Doors</h1>
